...
VERSION_NAME=$(cat ${APPCENTER_OUTPUT_DIRECTORY}/output-metadata.json | jq '.elements.object[0].versionName')
VERSION_CODE=$(cat ${APPCENTER_OUTPUT_DIRECTORY}/output-metadata.json | jq '.elements.object[0].versionCode')
